...
/// Pure-Swift SHA-256 implementation (FIPS 180-4), dependency-free so the core target
/// compiles on Linux without swift-crypto. Constant-time with respect to message content.
enum SHA256Digest {
